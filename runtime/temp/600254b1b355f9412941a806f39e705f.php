<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"F:\xampp\htdocs\chzu\public/../application/index\view\html\expert_info_edit.html";i:1567669546;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!--<select name="fk_code_gender_id" id="fk_code_gender_id" lay-verify="required">-->
    <!--<option value="">请选择性别</option>-->
    <!--<option value="751">男</option>-->
    <!--<option value="752">女</option>-->
<!--</select>-->
<div class="x-body">
    <div class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <textarea name="professional_technical_expertise" id="professional_technical_expertise" placeholder="请输入" class="layui-textarea" lay-verify="required"></textarea>
        </div>
...
//            return false;
    ...
    $(function () {
        ...
        $("#bank_code").val(parent_json.bank_code);
        $("#cerificate_code").val(parent_json.cerificate_code);
        $("#age").val(parent_json.age);
        $("#birthday").val(parent_json.birthday);
        $("#social_security_cards_code").val(parent_json.social_security_cards_code);
        $("#title_certificate_code").val(parent_json.title_certificate_code);
        $("#position").val(parent_json.position);
        $("#first_graduate_school_and_major").val(parent_json.first_graduate_school_and_major);
        $("#highest_graduate_school_and_major").val(parent_json.highest_graduate_school_and_major);
        $("#marjor_age").val(parent_json.marjor_age);
        $("#working_age").val(parent_json.working_age);
        $("#phone").val(parent_json.phone);
        $("#img").attr('src','/chzu/public'+ parent_json.picture);
        $("#address").val(parent_json.address);
        $("#post_code").val(parent_json.post_code);
        $("#email_address").val(parent_json.email_address);
        $("#professional_technical_expertise").val(parent_json.professional_technical_expertise);
        $("#fk_code_bank_type_id").val(parent_json.fk_code_bank_type_id);
        $("#fk_code_title_id").val(parent_json.fk_code_title_id);
        $("#fk_org_id").val(parent_json.fk_org_id);
        $("#qualification").val(parent_json.qualification);
        $("#qualification_code").val(parent_json.qualification_code);
//        $("#resume").val(parent_json.resume);
//        $("#fk_code_gender_id option[text='男']").attr("selected", true);
//        $("#fk_code_gender_id").val("751");
//        $("#fk_code_gender_id").find("option[text='男']").attr("selected",true);
//        $("#fk_code_gender_id")[0].value = 751;
//        console.log(parent_json.fk_code_gender_id_number)
//        var select = 'dd[lay-value=' + parent_json.fk_code_gender_id_number + ']';
//        $('#fk_code_gender_id').siblings("div.layui-form-select").find('dl').find(select).click();
//        renderFrom();
    });
...
//                    从数据库获取省份名称填入到下拉框中
            ...
            var parent_json = eval('(' + parent.json + ')');
            /**
             * 将已有的信息填入到是否愿意参加科普培训下拉框中
             */
            if (parent_json.is_willing_attend_lectures == '是'){
                $('#is_willing_attend_lectures')[0].value = 1;
            } else if (parent_json.is_willing_attend_lectures == '否'){
                $('#is_willing_attend_lectures')[0].value = 0;
            } else {
                $('#is_willing_attend_lectures')[0].value = '';
            }

            /**
             * 将已有的信息填入到是否为应急专家下拉框中
             */
            if (parent_json.is_emergency == '是'){
                $('#is_emergency')[0].value = 1;
            } else if (parent_json.is_emergency == '否'){
                $('#is_emergency')[0].value = 0;
            } else {
                $('#is_emergency')[0].value = '';
            }
...
//                console.log(str)
                    $.each(da, function (i, json) {
                        ...
                        $('#province').val(parent_json.province_id);
                        renderFrom();
                    });
                }
            });
...
//                        $('#fk_code_bank_type_id').val(parent_json.fk_code_bank_type_id_number);
//                        renderFrom();
//                    });
//                }
//            });
...
//            $.ajax({
//                type: "GET",
//                url: "/chzu/public/xt/baseCodes/?flag=orgType&level=1",
//                data: {},
//                dataType: "json",
//                success: function (data) {
//                    var da = data.data;
...
//                        $('#fk_org_id').val(parent_json.fk_org_id_number);
//                        renderFrom();
//                    });
//                }
//            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(da, function (i, json) {
                        ...
                        $('#fk_code_gender_id').val(parent_json.fk_code_gender_id_number);
                        renderFrom();
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(da, function (i, json) {
                        ...
                        $('#fk_certificate_type_id').val(parent_json.fk_certificate_type_id_number);
                        renderFrom();
                    });
                }
            });
...
//                        $('#fk_code_title_id').val(parent_json.fk_code_title_id_number);
//                        renderFrom();
//                    });
//                }
//            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(da, function (i, json) {
                        ...
                        $('#fk_code_politics_status_id').val(parent_json.fk_code_politics_status_id_number);
                        renderFrom();
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(da, function (i, json) {
                        ...
                        $('#fk_code_profession_id1').val(parent_json.first_profession);
                        renderFrom();
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(da, function (i, json) {
                        ...
                        $('#fk_code_major_id').val(parent_json.fk_code_major_id_number);
                        renderFrom();
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(da, function (i, json) {
                        ...
                        $('#fk_code_first_education_id').val(parent_json.fk_code_first_education_id_number);
                        renderFrom();
                        $("#fk_code_highest_education_id").append($option2);
                        $('#fk_code_highest_education_id').val(parent_json.fk_code_highest_education_id_number);
                        renderFrom();
                    });
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(da, function (i, json) {
                        ...
                        $('#fk_code_highest_degree_id').val(parent_json.fk_code_highest_degree_id_number);
                        renderFrom();
                    });
                }
            });
            ...
            $.ajax({
                type: 'GET',
                url: "/chzu/public/xt/areas?parent_id="+parent_json.province_id,
                data: {},
                dataType: "json",
                success: function (data) {
                    var da = data.data;
...
//                        form.render('select', 'second');
            ...
            $.ajax({
                type: 'GET',
                url: "/chzu/public/xt/areas?parent_id="+parent_json.city_id,
                data: {},
                dataType: "json",
                success: function (data) {
                    var da = data.data;
                    $.each(da, function (i, json) {
                        var $option = $("<option value='" + json["key_id"] + "'>" + json["name"] + "</option>");
                        $("#area").append($option);
                        $('#area').val(parent_json.country_id);
                        renderFrom();
                    });
                }
            });
             ...
             */
                $.ajax({
                    type: 'GET',
                    url: "/chzu/public/xt/baseCodes/?flag=profession&parent_id="+parent_json.first_profession,
                    data: {},
                    dataType: "json",
                    success: function (data) {
                        var da = data.data;
                        ...
                        $.each(da, function (i, json) {
                            ...
                            $('#fk_code_profession_id').val(parent_json.fk_code_profession_id_number);
                            renderFrom();
                        });
                    }
                });
...
//        将已存在的简历赋值到富文本编辑器中
        layedit.setContent(index, parent_json.resume, true);
        /**
         * 使提交时富文本中的内容同步到textarea中
         */
        form.verify({
...
//            formData.append("address",data.field.address);
            ...
            formData.append("qualification",data.field.qualification);
            formData.append("qualification_code",data.field.qualification_code);
            formData.append("_method",'PUT');
            //发异步，把数据提交给php
            var parent_json = eval('(' + parent.json + ')');
            var key_id = parent_json.key_id;
            $.ajax({
                url: '/chzu/public/experInfo/'+ key_id,
                type: 'POST',
                dataType: 'json',
                data: formData,
