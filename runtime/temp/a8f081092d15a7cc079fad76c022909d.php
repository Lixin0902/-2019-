<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"F:\xampp\htdocs\chzu\public/../application/xt\view\html\admin_add.html";i:1564967394;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="password1" name="password1" lay-verify="required|pass" placeholder="密码不少于6位"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="password" name="password" lay-verify="required|pass|equal" placeholder="密码不少于6位"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
