<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"F:\xampp\htdocs\chzu\public/../application/xt\view\html\admin_organises_table.html";i:1566890395;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form">
        <div class="layui-form-item">
            <div class="layui-input-inline">
                <input type="text" id="codename" name="" placeholder="请输入单位名称" autocomplete="off" class="layui-input">
            </div>
            <button class="layui-btn" id="search" type="button" style="position: absolute;left: 207px;">查询</button>
        </div>
    </form>
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('新增单位信息','adminOrgAdd')"><i
                class="layui-icon"></i>新增单位信息
        </button>
    </xblock>
    <!--表格id-->
        ...
        table.on('tool(table2)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('确定要删除吗？', function (index) {
                    ...
                    //向服务端发送删除指令
                    $.ajax({
                        url: "/chzu/public/xt/organises/" + data['key_id'],
                        data: {
                            '_method': 'delete'
                        },
                        type: "post",
