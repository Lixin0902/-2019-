<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"F:\xampp\htdocs\chzu\public/../application/xt\view\html\admin_edit.html";i:1566548883;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="password" name="password" placeholder="请输入新密码且不少于6位"
                       autocomplete="off" class="layui-input">
            </div>
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            //发异步，把数据提交给php
            $.ajax({
                url: '/chzu/public/xt/users/' + key_id,
                type: 'POST',
                dataType: 'json',
                data: {
                    _method: 'PUT',
